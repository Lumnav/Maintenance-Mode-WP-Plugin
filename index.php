...
define('LUMNAV_GITHUB_USERNAME', 'your-github-username'); // Change to your GitHub username or organization
define('LUMNAV_GITHUB_REPO', 'landing-pages'); // Change to your repository name
